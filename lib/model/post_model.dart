...
class PostModel {
  ...
  PostModel? fromJson(Map<String, dynamic> json) {
    try {
      final List<String> convertedPostViewList = json[PostModelFieldNameConstants.postViewList] == null
      ? const []
      : (json[PostModelFieldNameConstants.postViewList] as List<dynamic>).map((e) => e.toString()).toList();
      final List<String> convertedcontentImageUrlList = json[PostModelFieldNameConstants.contentImageUrlList] == null
      ? const []
      : (json[PostModelFieldNameConstants.contentImageUrlList] as List<dynamic>).map((e) => e.toString()).toList();

      return PostModel (
        pid: json[PostModelFieldNameConstants.pid] ?? ErrorReplacementConstants.notFoundString,
        uploadUserUid: json[PostModelFieldNameConstants.uploadUserUid] ?? ErrorReplacementConstants.notFoundString,
        userNickname: json[PostModelFieldNameConstants.userNickname] ?? ErrorReplacementConstants.notFoundString,
        userProfileURL: json[PostModelFieldNameConstants.userProfileURL] ?? ErrorReplacementConstants.notFoundString,
        postTitle: json[PostModelFieldNameConstants.postTitle] ?? ErrorReplacementConstants.notFoundString,
        postContent: json[PostModelFieldNameConstants.postContent] ?? ErrorReplacementConstants.notFoundString,
        contentImageUrlList: convertedcontentImageUrlList,
        uploadTime: json[PostModelFieldNameConstants.uploadTime],
        isPostImageBool: json[PostModelFieldNameConstants.isPostImageBool] ?? false,
        category: CategoryType.stringToCategory(json[PostModelFieldNameConstants.category]),
        postLikes: json[PostModelFieldNameConstants.postLikes] ?? 0,
        postViewList: convertedPostViewList,
        postViewListLength: json[PostModelFieldNameConstants.postViewList] ?? -1
      );
    } catch (error) {
